...
#define CLCD_CONTROL_PORT  PORT_C

/*Define if LCD in 4bit MODE connection */

#if CLCD_MODE == CLCD_4BIT
#define CLCD_DB4_PIN      Pin_4
#define CLCD_DB5_PIN      Pin_5
#define CLCD_DB6_PIN      Pin_6
#define CLCD_DB7_PIN      Pin_7
#endif

#define CLCD_RS_PIN        Pin_2
#define CLCD_RW_PIN        Pin_1
#define CLCD_E_PIN         Pin_0
